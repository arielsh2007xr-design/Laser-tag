...
const faqs = [
  {
    q: 'מהו לייזר טאג?',
    a: 'לייזר טאג הוא משחק קרב אסטרטגי וטקטי המדמה לחימה אמיתית באמצעות רובי לייזר. כל שחקן הוא לוחם בשדה הקרב, מוגן בגלימת שריון ומצויד ברובה לייזר, ועליו להתמודד מול שחקנים אחרים – לבד או לצד הקבוצה. המטרה היא להשיג את מקסימום הנקודות על ידי "חיסול" שחקנים אחרים תוך הימנעות מלהיחסל בעצמכם.',
  },
  {
    q: 'האם הלייזר מסוכן?',
    a: 'הלייזר הוא מסוג אינפרא-אדום — בטוח לחלוטין, ללא כל פוטנציאל נזק לעיניים.',
  },
  {
    q: 'האם זה כואב?',
    a: 'לייזר טאג שקול לפיינטבול — אלא שלא כמו פיינטבול, אין כאב ואין בלגן. אין שום מגע פיזי בגוף. פגיעות נרשמות על ידי רובה הלייזר או הגלימה.',
  },
  {
    q: 'לאיזה גיל זה מתאים?',
    a: 'הרובים הרבה פחות מורכבים מרובי פיינטבול ואינם גורמים לכאב, ולכן לייזר טאג מתאים לכל הגילאים. אנחנו ממליצים על גיל 6 ומעלה כדי לשמור על הציוד.',
  },
  {
    q: 'כמה משתתפים יכולים לשחק?',
    a: 'קבוצות של 2 עד 60 משתתפים בו-זמנית! המתחם שלנו מתאים גם לקבוצות קטנות וגם לאירועים גדולים — ימי הולדת, בר/בת מצווה, ימי גיבוש, ואירועי חברות.',
  },
  {
    q: 'מה כולל כל משחק?',
    a: 'כל חבילה כוללת הכנה ותדרוך (~20 דקות), ואז שמשות משחק פעיל: שמשה אחת (20 דקות), כפול (40 דקות), או משולש (60 דקות). הציוד — שריון + רובה לייזר — כלול במחיר.',
  },
  {
    q: 'מה שעות הפעילות?',
    a: "א'–ד': 09:00–24:00 | ה': 09:00–01:30 | ו': 09:00–18:00 | מוצ\"ש: אחרי יציאת שבת–01:00. המתחם שומר שבת. מומלץ לאשר זמינות לפני ההגעה.",
  },
  {
    q: 'איפה אתם ממוקמים?',
    a: 'אנחנו נמצאים ברחוב הבונים 4, אזור התעשייה פולג, נתניה. ישנה חניה חינמית ונוחה ממש ליד המתחם, עם גישה קלה מכל הכיוונים.',
  },
]
